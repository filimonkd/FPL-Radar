> **SUPERSEDED — historical record.** v0.3 (docs/ARCHITECTURE.md) replaces this document's §12, §13, the persistence parts of §15, and §17; all other sections stand unless v0.3 says otherwise.
